...
function ajmerPlaces(subOptionId: string, items: Array<[string, string]>): PlannerPlace[] {
  return items.map(([slug, label]) => ({
    id: `pl:ajmer:${subOptionId}:${slug}`,
    subOptionId,
    label,
  }))
}
...
/**
 * Ajmer-specific pins for every planner sub-option (other cities keep generic templates).
 */
export const AJMER_PLACES_BY_SUB: Partial<Record<string, PlannerPlace[]>> = {
  /* ——— Heritage ——— */
  'heritage-forts': ajmerPlaces('heritage-forts', [
  ...
  'heritage-museums': ajmerPlaces('heritage-museums', [
  ...
  'heritage-walks': ajmerPlaces('heritage-walks', [
  ...
  'heritage-audio': ajmerPlaces('heritage-audio', [
  ...
  /* ——— Spiritual ——— */
  'spiritual-temples': ajmerPlaces('spiritual-temples', [
  ...
  'spiritual-dargah': ajmerPlaces('spiritual-dargah', [
  ...
  'spiritual-festivals': ajmerPlaces('spiritual-festivals', [
  ...
  'spiritual-quiet': ajmerPlaces('spiritual-quiet', [
  ...
  /* ——— Food ——— */
  'food-thali': ajmerPlaces('food-thali', [
  ...
  'food-street': ajmerPlaces('food-street', [
  ...
  'food-sweets': ajmerPlaces('food-sweets', [
  ...
  'food-cafe': ajmerPlaces('food-cafe', [
  ...
  /* ——— Markets ——— */
  'markets-textile': ajmerPlaces('markets-textile', [
  ...
  'markets-crafts': ajmerPlaces('markets-crafts', [
  ...
  'markets-spices': ajmerPlaces('markets-spices', [
  ...
  'markets-jewellery': ajmerPlaces('markets-jewellery', [
  ...
  /* ——— Sunset ——— */
  'sunset-rooftop': ajmerPlaces('sunset-rooftop', [
  ...
  'sunset-lake': ajmerPlaces('sunset-lake', [
  ...
  'sunset-fort': ajmerPlaces('sunset-fort', [
  ...
  'sunset-desert': ajmerPlaces('sunset-desert', [
  ...
  /* ——— Nature ——— */
  'nature-lakes': ajmerPlaces('nature-lakes', [
  ...
  'nature-gardens': ajmerPlaces('nature-gardens', [
  ...
  'nature-wildlife': ajmerPlaces('nature-wildlife', [
  ...
  'nature-hills': ajmerPlaces('nature-hills', [
  ...
  /* ——— Photo ——— */
  'photo-icons': ajmerPlaces('photo-icons', [
  ...
  'photo-lanes': ajmerPlaces('photo-lanes', [
  ...
  'photo-stepwell': ajmerPlaces('photo-stepwell', [
  ...
  'photo-portrait': ajmerPlaces('photo-portrait', [
  ...
  /* ——— Culture ——— */
  'culture-folk': ajmerPlaces('culture-folk', [
  ...
  'culture-puppet': ajmerPlaces('culture-puppet', [
  ...
  'culture-craft': ajmerPlaces('culture-craft', [
  ...
  'culture-festival': ajmerPlaces('culture-festival', [
  ...
  /* ——— Adventure ——— */
  'adv-camel': ajmerPlaces('adv-camel', [
  ...
  'adv-zipline': ajmerPlaces('adv-zipline', [
  ...
  'well-pool': ajmerPlaces('well-pool', [
  ...
  'well-yoga': ajmerPlaces('well-yoga', [
  ...
  'well-unplanned': ajmerPlaces('well-unplanned', [
  ...
  /* ——— Day trip ——— */
  'daytrip-nearby': ajmerPlaces('daytrip-nearby', [
  ...
  'daytrip-pushkar': ajmerPlaces('daytrip-pushkar', [
  ...
  'daytrip-fort': ajmerPlaces('daytrip-fort', [
  ...
  'daytrip-custom': ajmerPlaces('daytrip-custom', [
  ...
  /* ——— Night ——— */
  'night-lit': ajmerPlaces('night-lit', [
  ...
  'night-food': ajmerPlaces('night-food', [
  ...
  'night-cultural': ajmerPlaces('night-cultural', [
  ...
  'night-early': ajmerPlaces('night-early', [
